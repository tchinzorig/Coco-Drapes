/* HashRouter works on any static host (GitHub Pages, custom domains,
   ...
   Lives here (not main.jsx) so components can also check which router is
   active — e.g. target="_blank" links only work under hash routing. */
export function hashRoutingAvailable() {
  try {
...
export const HASH_ROUTING = hashRoutingAvailable();
